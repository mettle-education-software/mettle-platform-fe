...
//     }, [isPlaying, duration]);
//
//     // Ensure the animation starts when playing
//     useEffect(() => {
//         if (isPlaying) {
//             animationRef.current = requestAnimationFrame(updateProgress);
...
//             setCurrentTime(typeof seekTime === 'number' ? seekTime : 0);
//         }
//     };
//
...
//         const newTime = percentage * duration;
//
//         setCurrentTime(newTime); // Update the progress bar visually
//     };
//
...
//         const newTime = percentage * duration;
//
//         seek(newTime); // Update the audio playback position
//
